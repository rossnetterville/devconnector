  ...
  return (
    <Fragment>
        ...
        <div className="form-group">
            ...
            <div className="form-group">
            <p><input type="checkbox" name="current" checked={current} value={current} onChange={e => {setFormData({...formData, current:!current}); toggleDisabled(!toDateDisabled)}} /> {' '}Currently Studying</p>
        </div>
        <div className="form-group">
            <h4>To Date</h4>
